...
|---------|------|------|----------------|--------------|
| v1.0.5 | 2026-07-07 | Patch | Privacy scrub — genericised the worked example (real client business replaced with the fictional "Riverside Bookings"); no rule or behaviour change | Repo genericisation for public release |
