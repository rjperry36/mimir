...
```
roster-appdev/
├── roster-appdev-v1.0.3.md          ← This document (master roster)
└── agents/
    ...
    ├── agent-05-repo-cicd-v1.0.2.yaml
    ├── agent-06-database-engineer-v1.0.0.yaml
    ├── agent-07-backend-developer-v1.0.0.yaml
...
kickoff (all AOM-required sections present, condensed cycle and briefs) and deepen to
full at v1.1.0 as delivery data accrues.
